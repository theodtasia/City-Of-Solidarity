      ...
      <div class="row">
	   ...
	   <div class="row">
        <div class="col-md-12 col-sm-12">
          <?php
			require('connection.php');
			$sql="SELECT id,username FROM usertable WHERE isvolun=1 OR isvolun=2 ORDER BY id";
			$result=mysqli_query($conn,$sql);
			echo '<table class="table table-striped">
					  <thead>
						<tr>
						  <th scope="col">#</th>
						  <th scope="col">ID Χρήστη</th>
						  <th scope="col">Username Χρήστη</th>
					...
					echo'</thead>
							  <tbody>
								<tr>
								  ...
								  <td>'.$row['id'].'</td>
								  <td>'.$row['username'].'</td>
								  <td><a href="nmember_delete.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to delete this newsletter?\');" title="delete"><i class="fas fa-user-minus"></i></a></td>
								</tr>';
								$i++;
