					...
					echo'</thead>
							  <tbody>
								<tr>
								  ...
								  <td>'.$row['name'].'</td>
								  <td>'.$row['email'].'</td>
								  <td><a href="newsmember_delete.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to delete this newsletter?\');" title="delete"><i class="fas fa-user-minus"></i></a></td>
								</tr>';
								$i++;
