...
$sql3="SELECT name_organ FROM user_info WHERE user_id='$id' AND lang='en'";
...
$_SESSION["changeLang"] = 'organsEN.php?organ='.$name.'';
...
<section class="section pb-5">
  ...
  <div class="row">
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCYdyiIJfblsqOMP9UkaL1pwe4NB7T2-Zs&callback=initMap" ></script>
      <br>
      <!--Buttons-->
