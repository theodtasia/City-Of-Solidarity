...
$_SESSION["changeLang"] = 'profileEN.php'; 

$_SESSION["pageTitle"] = 'Προφίλ'; 
$_SESSION["langu"] = 'gr';
...
<main class="article-content"> 
  <section class="section-1"> 
    ...
    <div id="myAlert" class="alert alert-success alert-dismissible fade show">
        <strong><i class="fas fa-check-circle fa-2x" style="margin-right:20px;"></i></strong> Εγγραφήκατε επιτυχώς!
...
<div class="container">
    ...
    <div class="row">
      ...
      <div class="text-center">
        <img src="./img/<?php echo $row['logo']?>" class="avatar img-circle img-thumbnail" alt="Χωρίς Φωτογραφία">
		...
		<div class="col-md-8" style="margin-top:1rem ; margin-left:5rem">
		  ...
		  <h4> Εδώ μπορείτε να εισάγετε τα στοιχεία του οργανισμού σας, ώστε να δημιουργηθεί η σελίδα του στο δίκτυο μας, σε ελληνικά και σε αγγλικά </h4>
      </div>
	</hr><br>
      <!--/col-3-->
    	<div class="col-sm-10">
                ...
                <div class="form-group row">
                  ...
                  <button type="submit" class="btn btn-primary px-4 float-left" name="save" id="save" value="save">Αποθήκευση</button>
		</div>
			</form>
             </div>
		<div class="HOVER">
        <a href="actprofilGR.php"><h4><i class="fas fa-cogs"></i>
Επεξεργασία Δράσεων</h4></a>
			<a href="needs_managementGR.php"><h4><i class="fas fa-eraser"></i>
Διαχείριση Αναγκών</h4></a>
		</div>
          </div>
